...
public class SpecialVendingMachine {
     ...
     */
    public SpecialVendingMachine(ArrayList<ItemSlot> slots) {
    ...
    public void printSpecialMessage(ArrayList<Integer> selectedSlots) {
        // Define the different combinations you want to check
        ArrayList<Integer> combo1 = new ArrayList<>();
        combo1.add(1); 
        combo1.add(3); 
        ...
        combo2.add(1); 
        combo2.add(4); 
        ArrayList<Integer> combo3 = new ArrayList<>();
        combo2.add(2); 
        combo2.add(3); 
        ArrayList<Integer> combo4 = new ArrayList<>();
        combo2.add(2); 
        combo2.add(4); 
    
        if (selectedSlots.containsAll(combo1)) {
            System.out.println("You bought Chicken Rice!");
        }

        if (selectedSlots.containsAll(combo2)) {
            System.out.println("You bought Beef Rice! ");
        }
         if (selectedSlots.containsAll(combo3)) {
            System.out.println("You bought Chicken Noodle!");
        }

        if (selectedSlots.containsAll(combo4)) {
            System.out.println("You bought Beef Noodle! ");
        }
